...
export const CardIndexType = () => {
    return (
        ...
        <Card sx={{ backgroundColor: 'rgba(208, 100, 0, 0.9)' }}>
                ...
                <Box display='flex' justifyContent='center'>
                    <Box display='flex' alignSelf='center' sx={{ display: { xs: 'none', sm: 'none', md: 'block' } }}>
                        <Box sx={{ backgroundColor: 'rgba(0, 0, 0, 0.3)', }}>
                            <Typography variant='h4' sx={{ m: 1, color: 'white' }} className='typeWriter'>Hi! I m Jorge Ochipinti. Thanks for visit my web!</Typography>
                        </Box>
                        <Box >
                            <Contact />
                        </Box>
